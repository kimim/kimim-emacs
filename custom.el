(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (magit which-key smex deft ag everything which-key-mode undo-tree imenu-anywhere imenu+ bookmark+ bm company-jedi www-synonyms synonyms dumb-jump goto-last-change multiple-cursors company-dict wgrep-ag "swiper" counsel swiper swoop company-c-headers company-irony-c-headers flycheck-irony projectile company-irony irony color-theme path-headerline-mode auto-highlight-symbol autopair paredit swift-mode mocker window-numbering volatile-highlights use-package pallet package-build shut-up epl git commander f s cask markdown-mode ggtags org jedi col-highlight ox-ioslide company history drag-stuff whole-line-or-region w32-registry ox-html5slide htmlize graphviz-dot-mode google-c-style gnuplot find-file-in-repository fill-column-indicator elpy ecb cygwin-mount color-theme-github browse-kill-ring bbdb ace-window ace-isearch)))
