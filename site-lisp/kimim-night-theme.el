  ...
  (apply 'custom-theme-set-faces 'kimim-night
         (mapcar
          ...
          `((default :foreground ,kimim-night-fg :background ,kimim-night-bg)
            ...
            (mode-line :foreground "white" :background "gray10" :box nil :height 0.85)
            (mode-line-inactive :foreground "light blue" :background "gray15" :box nil :height 0.85)
            (mode-line-buffer-id :foreground "light blue" :background "gray10" :box nil :weight bold)
            ...
            (swiper-line-face :background "turquoise4")
