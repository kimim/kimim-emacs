...
(let ((class '((class color) (min-colors 88)))
      ...
      (kimim-theme-region "light blue")
      (kimim-theme-shadow "grey80")
      (kimim-theme-highlight "gray12")
      (kimim-theme-modeline-bg "RoyalBlue4"))
  (apply 'custom-theme-set-faces 'kimim-night
         (mapcar
          ...
          `((default :foreground ,kimim-theme-fg :background ,kimim-theme-bg)
            ...
            (mode-line :foreground "white" :background ,kimim-theme-modeline-bg :box nil :height 0.85)
            (mode-line-inactive :foreground "light blue" :background ,kimim-theme-modeline-bg :box nil :height 0.85)
            (mode-line-buffer-id :foreground "light blue" :box nil :weight bold)
