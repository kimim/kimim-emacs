...
(defun org-toggle-office ()
  ...
  (setq org-agenda-files (list (concat org-path-home "capture.org")
                               (concat org-path-work "gtd/")
                               (concat org-path-work "gtd/projects/")
...
(setq org-capture-templates
      '(("t" "Task" entry (file+headline (concat org-path-home "capture.org") "Inbox")
		 "* %?\n/Entered on %U/ \\\\")
        ("o" "Action" entry (file+headline (concat org-path-home "capture.org") "Inbox")
         "* OPEN %?\n/Entered on %U/ \\\\")
        ("b" "Bug" entry (file+headline (concat org-path-work "gtd/projects/prj-maint.org") "Maintenance")
         "* OPEN PRC:%?\n/Entered on %U/ \\\\")
        ("h" "Habit" entry (file+headline (concat org-path-home "world.org") "Habit")
         "* %?  :habit:\n/Entered on %U/ \\\\")
        ("m" "Meet - 會議紀要討論結果" entry (file+datetree (concat org-path-work "journal/meeting-journal.org"))
		 "* %?")
        ("p" "Proj - 彙總項目進度更新" entry (file+datetree (concat org-path-work "journal/project-journal.org"))
		 "* %?")
        ("l" "PACT - 研發中心事件記錄" entry (file+datetree (concat org-path-work "journal/lab-journal.org"))
		 "* %?\n%U")
        ("e" "Team - 小組工作更新記錄" entry (file+datetree (concat org-path-work "journal/team-journal.org"))
		 "* %?\n%U")
        ("w" "Work - 工作感悟學習筆記" entry (file+datetree (concat org-path-home "journal/work-journal.txt"))
		 "* %?\n  %i")
