...
=======
>>>>>>> 0ca7b40bed0464afabd50aebe41bdb63a869a79a
...
(defun org-toggle-office ()
  ...
  (setq org-refile-files (append (list (concat path-gtd-work "capture.org")
                                 ...
                                 (file-expand-wildcards (concat path-gtd-work "office/*.org"))
                                 (file-expand-wildcards (concat path-gtd-work "office/*/*.org"))
                                 (file-expand-wildcards (concat path-gtd-home "home/kimi.org"))))
...
(setq org-capture-templates
      '(("t" "Inbox Task" entry (file+headline (concat path-gtd-work "capture.org") "Inbox")
		 "* %?\n/Entered on %U/ \\\\")
        ("o" "Inbox Actions" entry (file+headline (concat path-gtd-work "capture.org") "Inbox")
         "* OPEN %?\n/Entered on %U/ \\\\")
        ("b" "Bugs" entry (file+headline (concat path-gtd-work "office/projects/prj-maint.org") "Maintenance")
         "* OPEN PRC:%?\n/Entered on %U/ \\\\")
        ("h" "Habit - 好的行為習慣" entry (file+headline (concat path-gtd-home "world.org") "Habit")
         "* %?  :habit:\n/Entered on %U/ \\\\")
        ("w" "Work Journal - 工作中的感悟" entry (file+datetree (concat path-gtd-work "work-journal.org"))
		 "* %?\n  %i")
        ("m" "Meeting Journal - 會議紀要和討論結果" entry (file+datetree (concat path-gtd-work "meeting-journal.org"))
		 "* %?")
        ("a" "R&D Journal" entry (file+datetree (concat path-gtd-work "lab-journal.org"))
		 "* %?")
        ("n" "New word" entry (file+headline (concat path-gtd-home "home/new-words.org") "new-words")
		 "* %?\n")))
