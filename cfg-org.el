...
(setq org-capture-templates
      '(("t" "Inbox Task" entry (file+headline (concat org-path-home "capture.org") "Inbox")
        ...
        ("o" "Inbox Actions" entry (file+headline (concat org-path-home "capture.org") "Inbox")
         "* OPEN %?\n/Entered on %U/ \\\\")
        ("b" "Bugs" entry (file+headline (concat org-path-work "gtd/projects/prj-maint.org") "Maintenance")
         "* OPEN PRC:%?\n/Entered on %U/ \\\\")
        ("h" "Habit - 好的行為習慣" entry (file+headline (concat org-path-home "world.org") "Habit")
         "* %?  :habit:\n/Entered on %U/ \\\\")
        ("m" "Meeting Journal - 會議紀要和討論結果" entry (file+datetree (concat org-path-work "journal/meeting-journal.org"))
		 "* %?")
        ("p" "Project Journal - 收集彙總項目進度更新" entry (file+datetree (concat org-path-work "journal/project-journal.org"))
		 "* %?")
        ("l" "Lab Journal" entry (file+datetree (concat org-path-work "journal/lab-journal.org"))
		 "* %?\n%U")
        ("w" "Work Journal" entry (file+datetree (concat org-path-home "journal/work-journal.txt"))
		 "* %?\n  %i")
        ("k" "Life Journal" entry (file+datetree (concat org-path-home "journal/life-journal.txt"))
         "* %?\n%U")
