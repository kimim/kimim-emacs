...
download and install it in your machine, for example, at ==C:\cygwin64=. Then
you can use mintty.exe to work with bash.
...
~smartparens-mode~[fn:11] is a general purpose mode for dealing with
...
Polymode [fn:16] is a framework for multiple major modes (MMM) inside a single
...
name handling function can be found from emacs manual[fn:17].
...
Org-roam implements =zettelkasten= method [fn:18] used by famous German socialogist
Niklas Luhmann[fn:19].
...
[fn:11] https://github.com/Fuco1/smartparens
...
[fn:16] https://polymode.github.io/

[fn:17] https://www.gnu.org/software/emacs/manual/html_node/elisp/File-Name-Components.html

[fn:18] https://zettelkasten.de/

[fn:19] https://en.wikipedia.org/wiki/Niklas_Luhmann
