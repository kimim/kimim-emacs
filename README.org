...
For Apple macOS, For Windows, most UNIX tools are installed
already. Homebrew [fn:6] is used to install additional applications if missing
in macOS.
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; bookmark setting
  (setq bookmark-default-file (concat path-sync-home "emacs.bmk"))
...
#+BEGIN_SRC emacs-lisp
  (require 'yasnippet)
  (yas-global-mode 1)
  (yas-load-directory (concat path-sync-home "tools/snippets"))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun org-toggle-office ()
    ...
    (setq org-agenda-files (list (concat path-org-home "capture.org")
                                 (concat path-org-work "gtd-work/")
                                 (concat path-org-work "gtd-work/projects/")
                                 (concat path-org-home "world.org")))
    (setq org-refile-files (append (list (concat path-org-home "capture.org")
                                         (concat path-org-home "world.org")
                                         (concat path-org-home "new-words.org")
                                         (concat path-org-home "gtd-home/kimi.org"))
                                   (file-expand-wildcards (concat path-org-work "gtd-work/*.org"))
                                   (file-expand-wildcards (concat path-org-work "gtd-work/*/*.org"))))
  ...
  (defun org-toggle-home ()
    (interactive)
        ...
        (setq org-agenda-files (list (concat path-org-home "capture.org")
                                     (concat path-org-home "world.org")
                                     (concat path-org-home "gtd-home/")))
        (setq org-refile-files (append (list (concat path-org-home "capture.org")
                                             (concat path-org-home "world.org"))
                                       (file-expand-wildcards (concat path-org-home "gtd-home/*.org"))))
