...
#+begin_src emacs-lisp
(setq frame-title-format "GNU/Emacs - https://www.gnu.org/software/emacs")
#+end_src
...
(use-package dired
  ...
  :custom
  (dired-listing-switches "-AGvhlgo")
...
(use-package ox-latex
  ...
  (use-package org-ref) ;; latex-classes need default bib file
...
(use-package plantuml-mode
  ...
  ;; redefine org-babel-execute:plantuml support different export file extension
...
This function is called by `org-babel-execute-src-block'."
  (let*
      ((cmdline (cdr (assq :cmdline params)))
       ...
       (export-ext (cond
                    ((eq 'latex org-export-current-backend) "eps")
                    ((eq 'html org-export-current-backend) "svg")
                    (t "svg")))
       (out-file-base (or (cdr (assq :file params))
                          (concat "images/" (file-name-base in-file))))
       (out-file (if (file-name-extension out-file-base)
                     out-file-base
                   (concat out-file-base "." export-ext)))
       (_ (message (concat "out file " out-file-base out-file)))
       (temp (setf (alist-get :file params) out-file))
...
(use-package org
  ...
  ;;             ;;(auto-fill-mode)
  ;;             ;;(drag-stuff-mode -1)
  ;;             ;;(org-toggle-pretty-entities) ;; source code!
  ;;             ))
...
Org-roam implements =zettelkasten= method [fn:23] used by famous German socialogist
Niklas Luhmann[fn:24].
...
(use-package org-roam
  :ensure t
  :functions (org-roam--get-title-path-completions
              org-roam-completion--completing-read
              org-roam-shield-region
...
[fn:21] https://polymode.github.io/

[fn:22] https://www.gnu.org/software/emacs/manual/html_node/elisp/File-Name-Components.html

[fn:23] https://zettelkasten.de/

[fn:24] https://en.wikipedia.org/wiki/Niklas_Luhmann
