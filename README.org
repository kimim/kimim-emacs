  ...
  (use-package elfeed
    ...
    (setq elfeed-feeds
          '(("http://planet.emacsen.org/atom.xml" emacs)
            ("https://news.google.com/news/rss/headlines/section/topic/WORLD?ned=us&hl=en" News)
            ...
            ("http://www.france24.com/en/top-stories/rss" FR)
            ("http://en.rfi.fr/france/rss" FR)
            ...
            ("https://feedx.net/rss/one.xml" blog))))
#+END_SRC
