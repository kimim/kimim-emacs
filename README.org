...
Mermaid [fn:20] is another js based diagramming and charting tool. To
...
(use-package ob-mermaid
  ...
  (add-to-list 'org-latex-minted-langs '(mermaid "text")))
#+end_src
...
[fn:20] https://mermaid-js.github.io/
...
[fn:25] https://www.gnu.org/software/emacs/manual/html_node/elisp/File-Name-Components.html

[fn:24] https://emacs.stackexchange.com/questions/22283/dired-group-directories-and-symlinks-to-directories-first
