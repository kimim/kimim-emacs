...
#+BEGIN_SRC emacs-lisp
  (use-package yasnippet
    ...
    :config
    (add-to-list
     'yas-snippet-dirs (concat kimim/path-sync "emacs.d/snippets"))
    (yas-global-mode 1)
    (use-package company)
...
#+BEGIN_SRC emacs-lisp
  (use-package company-dict
    ...
    (setq company-dict-dir (concat kimim/path-sync "emacs.d/dict"))
...
#+BEGIN_SRC emacs-lisp
  (use-package ebdb
    ...
    :ensure t
    :config
    (setq ebdb-sources (concat kimim/path-sync "emacs.d/ebdb"))
...
#+BEGIN_SRC emacs-lisp
  (use-package bbdb
    ...
    :bind
    :config
    (setq bbdb-file (concat kimim/path-sync "emacs.d/bbdb"))
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package gnus
    ...
    (setq mail-signature-file (concat kimim/path-sync "emacs.d/signature.txt"))
...
#+BEGIN_SRC emacs-lisp
  (use-package elfeed
    ...
    (setq elfeed-db-directory (concat kimim/path-sync "elfeed"))
