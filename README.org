...
;; choose hi lock color automatically
...
(use-package company
  ...
  (setq company-backends
        (nconc '((:separate company-capf company-yasnippet) company-ispell)
               company-backends)))
#+end_src
...
(use-package ox-latex
  ...
  (setq org-latex-pdf-process
        `(
          ...
          ;; "xelatex -shell-escape %f"
          ;; "xelatex -shell-escape %f"
          "latexmk -xelatex -shell-escape %f" ;; for bibtex and biber use
          ))
  ...
  (setq org-latex-default-packages-alist
        (quote
         (("" "inputenc" t ("pdflatex"))
          ...
          ("" "lettrine" t nil)
          ("" "capt-of" nil nil)
          ("citestyle=numeric, bibstyle=numeric, hyperref=true,
...
(use-package org-ref
  ...
  :bind (("C-'" . org-roam-node-random)
         :map org-mode-map
         ("C-'" . org-roam-node-random)
         ("C-x m p" . org-ref-open-pdf-at-point)
         ("C-x m d" . kimim/org-ref-open-pdf-in-dired))
  :custom
  ...
  :demand t
  :config
  (defun kimim/org-ref-open-pdf-in-dired ()
