...
(use-package sunrise-commander
  ...
  :custom ((sr-cursor-follows-mouse nil)
...
(use-package dired
  ...
  :custom ((dired-listing-switches "-AGvhlgo")
...
(use-package bookmark
  :custom ((bookmark-default-file "~/.emacs.d/emacs.bmk")
...
(use-package calendar
  :custom ((diary-file kimim/file-diary)
...
(use-package ox-latex
  ...
  :custom ((org-latex-image-default-width "\\maxwidth{.9\\linewidth}"))
  :config
  (require 'ox-latex)
...
(use-package org-ref
  ...
  :custom ((reftex-default-bibliography `(,(concat kimim/path-ref "references.bib")))
