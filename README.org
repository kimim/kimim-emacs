...
(use-package sunrise-commander
  ...
  :custom ((sr-cursor-follows-mouse nil)
           ...
           (sr-listing-switches "-AGhlgo --group-directories-first")
           (sr-attributes-display-mask '(nil t nil nil nil nil t t))
...
(use-package dired
  ...
  :custom ((dired-listing-switches "-AGhlgo --group-directories-first"))
  :bind
  (("C-x C-j" . dired-jump)
   :map dired-mode-map
