...
To make use of this configuration, you can follow below shell commands to
prepare the emacs configuration files and folders:
...
#+BEGIN_SRC emacs-lisp
  (cond
   ((eq window-system 'w32)
    ...
    (set-fontset-font
     "fontset-default"
     'han (font-spec :family "Microsoft Yahei" :size 26))
...
#+BEGIN_SRC emacs-lisp
  (use-package yasnippet
    ...
    :config
    (add-to-list
     'yas-snippet-dirs (concat kimim/path-kimikit "emacs.d/snippets"))
    (yas-global-mode 1)
    (use-package company)
