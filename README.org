...
Cygwin project[fn:3] is required for this configuration in Windows, which is a
...
homebrew [fn:5] to install additional application if it is missing.
...
~smartparens-mode~[fn:13] is a general purpose mode for dealing with
...
Polymode [fn:18] is a framework for multiple major modes (MMM) inside a single
...
name handling function can be found from emacs manual[fn:19].
...
Org-roam implements =zettelkasten= method [fn:20] used by famous German socialogist
Niklas Luhmann[fn:21].
...
[fn:13] https://github.com/Fuco1/smartparens
...
[fn:18] https://polymode.github.io/

[fn:19] https://www.gnu.org/software/emacs/manual/html_node/elisp/File-Name-Components.html

[fn:20] https://zettelkasten.de/

[fn:21] https://en.wikipedia.org/wiki/Niklas_Luhmann
