...
Then start =emacs= from terminal, and right click the =emacs= to pin it to
taskbar, and click the property of this icon to add "C:\cygwin64\bin\run.exe
emacs" in the target field. This way will hide the black terminal.
...
#+begin_src emacs-lisp
  (use-package unicode-fonts
    ...
    ;; (let ((font-list (assoc "Bopomofo" unicode-fonts-block-font-mapping)))
    ;;   (setf (cadr font-list) (cons  "YaheiInconsolata" (cadr font-list))))
...
#+begin_src emacs-lisp
  (use-package doc-view
    ...
    (setq doc-view-image-width 1300))
#+end_src
