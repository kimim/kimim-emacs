  ...
  (use-package org
    ...
    (setq org-agenda-custom-commands
          '(("t" todo "TODO|OPEN"
            ...
            ("c" tags "clock"
             ((org-agenda-sorting-strategy '(priority-down))))))
    (setq kimim/capture-file (concat kimim/path-org "capture.org"))
    (setq kimim/capture-file-world (concat kimim/path-org "world.org"))
    (setq org-default-notes-file nil)
    (setq org-capture-templates
          '(("c" "Capture" entry (file+headline kimim/capture-file "Inbox")
             "* %?\n:PROPERTIES:\n:CAPTURED: %U\n:END:\n")
            ("t" "TODO" entry (file+headline kimim/capture-file "Inbox")
             "* TODO %?\n:PROPERTIES:\n:CAPTURED: %U\n:END:\n")
            ("o" "Action" entry (file+headline kimim/capture-file "Inbox")
             "* OPEN %?\n:PROPERTIES:\n:CAPTURED: %U\n:END:\n")
            ("h" "Habit" entry (file+headline kimim/capture-file-world "Habit")
             "* %?  :habit:\n:PROPERTIES:\n:CAPTURED: %U\n:END:\n")))
