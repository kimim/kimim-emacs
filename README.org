...
Install both libclang3.8 3.8.1-1 and libclang-devel 3.8.1-1 with =setup.exe=
...
#+BEGIN_SRC emacs-lisp
  (bind-key "C-c r" 'kimim/rename-file-and-buffer)
  ...
  (bind-key "<f9>" 'kimim/cyg)
  (bind-key "S-<f9>" 'kimim/cmd)
  (bind-key "<f10>" 'kimim/dc)
  ...
  (bind-key "C-c d" 'kimim/lookinsight)
