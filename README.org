...
Install msys2[fn:5], for example, to =C:\msys64=, then open
=C:\msys64\mingw64.exe=, and run:
...
Store. And Manjaro Linux for WSL2[fn:7] from
...
Clojure[fn:15] is a lisp over JVM. Emm, I like it.
...
Cider[fn:16] extends Emacs with support for interactive programming
in Clojure.
...
Polymode [fn:19] is a framework for multiple major modes (MMM) inside a single
...
[fn:7] http://kimi.im/2021-01-28-emacs-inside-manjaro-wsl2-windows
