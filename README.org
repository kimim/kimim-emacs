...
On Windows platform, we have three options: 1) MSYS2, 2) Cygwin, 3)
WSL2.
...
You can find Cygwin setup here: https://cygwin.com/setup-x86_64.exe ,
download and install it in your machine, for example, at
=C:\cygwin64=. Then you can use =mintty.exe= to work with =bash=.
...
Windows App Store. And Manjaro Linux for WSL2[fn:5] from
...
homebrew[fn:6] to install additional application if it is missing.
...
=package= [fn:7] is the modern =elisp= package management system, which
...
(use-package olivetti
  ...
  :custom ((olivetti-body-width (+ fill-column 10))
           ;; let tags show in ollivetti mode
           (org-tags-column (- fill-column))
           ;; image width in preview
           (org-image-actual-width `(,(* olivetti-body-width
                                         (frame-char-width)))))
...
The solution is to change the owner of =~/.emacs.d/server= [fn:8]
...
~smartparens-mode~[fn:9] is a general purpose mode for dealing with
...
that dash version higher than 2.18 is installed[fn:10].
...
Hook ~pdf-view-themed-minor-mode~ to ~pdf-view-mode~ to follow emacs theme color.
...
[fn:5] http://kimi.im/2021-01-28-emacs-inside-manjaro-wsl2-windows

[fn:6] http://brew.sh/

[fn:7] https://www.gnu.org/software/emacs/manual/html_node/emacs/Packages.html

[fn:8] https://github.com/syl20bnr/spacemacs/issues/381

[fn:9] https://github.com/Fuco1/smartparens

[fn:10] https://github.com/emacs-lsp/lsp-mode/issues/2622
...
[fn:19] https://www.gnu.org/software/emacs/manual/html_node/elisp/File-Name-Components.html

[fn:20] https://emacs.stackexchange.com/questions/22283/dired-group-directories-and-symlinks-to-directories-first

[fn:21] https://github.com/transcode-open/apt-cyg
